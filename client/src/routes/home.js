  ...
  return (
    <div id="app">
      <main>
        ...
        <div className="form">
          <div className="slider">
            ...
            <div className={`slide ${count === 3 ? "active" : ""}`}>
              ...
              {
                outcome === "Approved" && <> <h1>🎉 Welcome to New Bank!</h1>
                  <p>Success! You will recieve an email shortly with your next steps.</p></>
              }
              {
        ...
        <footer>
          <p><a href="https://github.com/Austin-Jones/new-bank-demo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Octicons-mark-github.svg/2048px-Octicons-mark-github.svg.png" alt="Github" width="40" /></a></p>
        </footer>
      </main>
      <div className="sidebar">
        ...
        <div className="card">
          <h1>A New way to bank</h1>
          <p>Customer focused platform with complete financial solutions. Join today and enjoy the perks. </p>
        </div>
      </div>
    </div>
  );
